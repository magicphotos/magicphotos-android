...
Item {
    ...
    SaveDialog {
        ...
        onOkPressed: {
            cartoonPage.focus         = true;
            cartoonPage.saveImageFile = file_path + "/" + file_name;

            cartoonEditor.saveImage(cartoonPage.saveImageFile);

            AndroidGW.refreshGallery(cartoonPage.saveImageFile);
        }
