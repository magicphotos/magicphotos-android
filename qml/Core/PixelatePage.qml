...
Page {
            ...
            ToolButton {
                ...
                onClicked: {
                    if (UIHelper.requestWriteStoragePermission()) {
                        ...
                        pixelateEditor.saveImage(UtilScript.generateImageFileName(UIHelper.getSaveDirectory()));
                    }
                }
            }
    ...
    function updateEditorParameters() {
        ...
        pixelateEditor.brushHardness = AppSettings.brushHardness;
    }
            ...
            Flickable {
                ...
                PixelateEditor {
                    ...
                    onMouseEvent: {
                        ...
                        if (eventType === PixelateEditor.MousePressed) {
                        ...
                        } else if (eventType === PixelateEditor.MouseMoved) {
                            helperRectangle.visible = true;
                        ...
                        } else if (eventType === PixelateEditor.MouseReleased) {
                    ...
                    function editorMode(scroll_mode, original_mode, effected_mode) {
                        if (scroll_mode) {
                            ...
                            return PixelateEditor.ModeOriginal;
                        } else if (effected_mode) {
                            return PixelateEditor.ModeEffected;
                        } else {
                            return PixelateEditor.ModeScroll;
                        }
                    }
