...
void DecolorizeEditor::changeImageAt(bool save_undo, int center_x, int center_y, qreal zoom_level)
{
...
void DecolorizeEditor::RepaintHelper(int center_x, int center_y, qreal zoom_level)
{
    if (CurrentImage.isNull()) {
